...
INSERT INTO Reservation (person_id, place_id, resource_id, date)
VALUES
    (1, 1, 1, '2023-01-05'),  -- Volkan reserved a camera
    (2, 2, 2, '2023-02-10'),  -- John reserved lighting
    (3, 3, 8, '2023-03-15'),  -- Michael reserved an audio accessory
    (4, 1, 5, '2023-04-20'),  -- Emily reserved lighting
    (5, 2, 4, '2023-05-25');  -- David reserved a camera
